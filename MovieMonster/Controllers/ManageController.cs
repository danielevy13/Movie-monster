...
using MovieMonster.Models.ManageViewModels;
...
namespace MovieMonster.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> DeleteUser()
        {
            ...
            //}
            //var user = await _userManager.FindByIdAsync("kdwfh");
            // IdentityUserLogin<ApplicationUser> login = new IdentityUserLogin<ApplicationUser>();
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("MovieMonster"),
